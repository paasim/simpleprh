...
#' @name simpleytj
#'
#' @importFrom dplyr filter is.tbl matches mutate_at slice vars
#' @importFrom httr content GET http_error
#' @importFrom jsonlite fromJSON
#' @importFrom lubridate ymd
#' @importFrom magrittr "%>%"
#' @importFrom purrr as_vector is_bare_list is_character is_scalar_character
#'  is_scalar_double is_scalar_integer keep map map_chr map_if map_lgl map2_lgl
#'  modify_if pluck set_names transpose walk "%||%"
